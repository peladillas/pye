...
// validate the variables ======================================================
	...
	if (empty($_POST['g-recaptcha-response'])) {
		...
		$data_recaptcha = array('secret' => '6LfU6BgTAAAAAHxouKP-PNB4mufDZE5fLNH4tSrK', 'response' => $_POST['g-recaptcha-response'],'remoteip'=>$_SERVER['REMOTE_ADDR']);
		...
		$errors['recaptcha'] = 'Verifica el ReCaptcha Verificacion.';
